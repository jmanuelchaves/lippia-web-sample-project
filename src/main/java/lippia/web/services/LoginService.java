...
public class LoginService extends ActionManager {
    ...
    public static void clickSearchButton() { click(GoogleConstants.SEARCH_BUTTON_NAME);
    }

    public static void completarUsuarioYContrasena() {
        setInput(LoginConstants.INPUT_USER_CSS, "standard_user");
        setInput(LoginConstants.INPUT_PASSWORD_CSS, "secret_sauce");
    }
    ...
    public static void completarUsuarioYContrasenainvalida() {
        setInput(LoginConstants.INPUT_USER_CSS, "locked_out_user");
        setInput(LoginConstants.INPUT_PASSWORD_CSS, "secret_sauce");
    }
    ...
    public static void verificarMensajeError() {
        ...
        Assert.assertTrue(getText(LoginConstants.ERROR_MESSAGE_XPATH).contains("Epic sadface: Sorry, this user has been locked out."));
    }
